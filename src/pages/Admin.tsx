  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex space-x-2 mb-6 bg-white p-2 rounded-lg shadow-sm w-fit border border-gray-100">
        <button className="bg-[#2c3e50] text-white px-4 py-2 rounded-md transition font-medium">Upcoming</button>
        <button className="text-gray-600 hover:bg-gray-100 px-4 py-2 rounded-md transition font-medium">Ongoing</button>
        <button className="text-gray-600 hover:bg-gray-100 px-4 py-2 rounded-md transition font-medium">Results</button>
      </div>
      
      {tournaments.length === 0 && <p className="text-gray-500 text-center py-10">No matches found.</p>}
